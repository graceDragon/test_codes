...
guanjia_accounts_xls = common.get_xls("stage_fenqi.xlsx", "staging_lists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class StagingLists(unittest.TestCase):
...
if __name__ == '__main__':
    StagingLists().test_staging_lists()
