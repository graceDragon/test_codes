...
guanjia_accounts_xls = common.get_xls("stage_fenqi.xlsx", "staging_applyforstaging", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class StagingApplyForStaging(unittest.TestCase):
    ...
    def test_staging_applyforstaginig(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    StagingApplyForStaging().test_staging_applyforstaginig()
