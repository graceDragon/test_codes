...
guanjia_accounts_xls = common.get_xls("stage_fenqi.xlsx", "staging_user_apply", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class StagingUserApply(unittest.TestCase):
    ...
    def test_staging_userapply(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    StagingUserApply().test_staging_userapply()
