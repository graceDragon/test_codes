...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "order_getperiod", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaOrderGetPeriod(unittest.TestCase):
    ...
    def test_guanjia_order_getperiod(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaOrderGetPeriod().test_guanjia_order_getperiod()
