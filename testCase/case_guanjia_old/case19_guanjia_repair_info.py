...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "repair_info", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRepairInfo(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaRepairInfo().test_guanjia_repair_info()
