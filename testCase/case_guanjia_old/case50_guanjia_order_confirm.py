...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "order_confirm", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaOrderConfirm(unittest.TestCase):
    ...
    def test_guanjia_order_confirm(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaOrderConfirm().test_guanjia_order_confirm()
