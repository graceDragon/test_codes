...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "user_show", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaUserShow(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaUserShow().test_guanjia_user_show()
