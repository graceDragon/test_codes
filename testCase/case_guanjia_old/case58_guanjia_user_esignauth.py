...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "user_esignauth", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaUserESignAuth(unittest.TestCase):
    ...
    def test_guanjia_user_esignauth(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaUserESignAuth().test_guanjia_user_esignauth()
