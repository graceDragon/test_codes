...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "electric_ordersubmit", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaElectricOrderSubmit(unittest.TestCase):
    ...
    def test_guanjia_electric_ordersubmit(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaElectricOrderSubmit().test_guanjia_electric_ordersubmit()
