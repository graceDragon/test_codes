...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "user_lists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaUserLists(unittest.TestCase):
    ...
    def test_guanjia_user_lists(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaUserLists().test_guanjia_user_lists()
