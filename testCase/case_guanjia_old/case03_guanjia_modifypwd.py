...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "test_modify_pwd", tag=tag)
print '测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaModifyPwd(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaModifyPwd().test_modify_pwd()
