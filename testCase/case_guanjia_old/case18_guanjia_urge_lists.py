...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "urge_lists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaUrgeLists(unittest.TestCase):
    ...
    def test_guanjia_urge_lists(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaUrgeLists().test_guanjia_urge_lists()
