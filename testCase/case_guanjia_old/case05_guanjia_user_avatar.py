...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "user_avatar", tag=tag)
print '测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaUserAvatar(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaUserAvatar().test_user_avatar()
