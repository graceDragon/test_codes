...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "urge_meter", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaUrgeMeter(unittest.TestCase):
    ...
    def test_guanjia_urge_meter(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaUrgeMeter().test_guanjia_urge_meter()
