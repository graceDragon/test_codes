...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "relet_add", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaReletAdd(unittest.TestCase):
    ...
    def test_guanjia_relet_add(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaReletAdd().test_guanjia_relet_add()
