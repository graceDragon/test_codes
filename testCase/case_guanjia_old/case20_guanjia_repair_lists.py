...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "repair_lists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRepairLists(unittest.TestCase):
    ...
    def test_guanjia_repair_lists(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRepairLists().test_guanjia_repair_lists()
