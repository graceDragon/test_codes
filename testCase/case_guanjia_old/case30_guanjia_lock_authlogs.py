...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "lock_authlogs", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLockAuthLogs(unittest.TestCase):
    ...
    def test_guanjia_lock_authlogs(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLockAuthLogs().test_guanjia_lock_authlogs()
