...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "repair_handle", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRepairHandle(unittest.TestCase):
    ...
    def test_guanjia_repair_handle(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRepairHandle().test_guanjia_repair_handle()
