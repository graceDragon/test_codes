...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "guanjia_community_list", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaCommunityList(unittest.TestCase):
    ...
    def test_guanjia_community_list(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaCommunityList().test_guanjia_community_list()
