...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "order_pending", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaOrderPending(unittest.TestCase):
    ...
    def test_guanjia_order_pending(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaOrderPending().test_guanjia_order_pending()
