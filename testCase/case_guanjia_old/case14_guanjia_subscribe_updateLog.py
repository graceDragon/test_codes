...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "subscribe_updateLog", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaUpdateLog(unittest.TestCase):
    ...
    def test_guanjia_update_log(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaUpdateLog().test_guanjia_update_log()
