...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "order_add", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaOrderAdd(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaOrderAdd().test_guanjia_order_add()
