...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "house_lists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaHouseLists(unittest.TestCase):
    ...
    def test_guanjia_house_lists(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaHouseLists().test_guanjia_house_lists()
