...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "user_upd", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaUserUpd(unittest.TestCase):
    ...
    def test_guanjia_user_upd(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaUserUpd().test_guanjia_user_upd()
