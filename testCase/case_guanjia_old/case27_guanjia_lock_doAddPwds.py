...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "lock_doAddPwds", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaDoAddPwds(unittest.TestCase):
    ...
    def test_guanjia_doaddpwds(self):
        """
        test body
        :return:
        """
