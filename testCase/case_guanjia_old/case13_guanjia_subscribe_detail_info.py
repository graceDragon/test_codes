...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "subscribe_detail_info", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaSubscribeDetailInfo(unittest.TestCase):
    ...
    def test_guanjia_subscribe_detail_info(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaSubscribeDetailInfo().test_guanjia_subscribe_detail_info()
