...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "signing_finduser", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaSignFinduser(unittest.TestCase):
    ...
    def test_guanjia_sign_finduser(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaSignFinduser().test_guanjia_sign_finduser()
