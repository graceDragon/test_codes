...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "user_auth", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaUserAuth(unittest.TestCase):
    ...
    def test_guanjia_user_auth(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaUserAuth().test_guanjia_user_auth()
