...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "electric_charge", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaElectricCharge(unittest.TestCase):
    ...
    def test_guanjia_electric_charge(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaElectricCharge().test_guanjia_electric_charge()
