...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "signing_add", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaSignAdd(unittest.TestCase):
    ...
    def test_guanjia_sign_add(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaSignAdd().test_guanjia_sign_add()
