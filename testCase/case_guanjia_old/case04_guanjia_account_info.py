...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "account_info", tag=tag)
print '测试用例数据列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaAccountInfo(unittest.TestCase):
    ...
    def checkResult(self):
        ...
        # 存储site_id
        # if 'user_info' in self.info['data'] and self.info['err_msg'] == 'success':
        #     site_id = self.info['data']['user_info']['site_id']
        #     localReadConfig.set_ini('SITE', 'site_id', site_id)
        # 断言返回状态码
...
if __name__ == '__main__':
    GuanJiaAccountInfo().test_account_info()
