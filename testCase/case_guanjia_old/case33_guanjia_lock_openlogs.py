...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "lock_openlogs", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLockOpenLogs(unittest.TestCase):
    ...
    def test_guanjia_lock_openlogs(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLockOpenLogs().test_guanjia_lock_openlogs()
