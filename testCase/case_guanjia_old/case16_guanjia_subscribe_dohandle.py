...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "subscribe_dohandle", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaSubscribeDoHandle(unittest.TestCase):
    ...
    def test_guanjia_subscribe_dohandle(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaSubscribeDoHandle().test_guanjia_subscribe_dohandle()
