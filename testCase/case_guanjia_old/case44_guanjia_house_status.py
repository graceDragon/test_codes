...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "house_status", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaHouseStatus(unittest.TestCase):
    ...
    def test_guanjia_house_status(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaHouseStatus().test_guanjia_house_status()
