...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "home_trading_aera", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class HomeTradingArea(unittest.TestCase):
    ...
    def test_home_trading_area(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    HomeTradingArea().test_home_trading_area()
