...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "signing_subbill", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class SigningSubBill(unittest.TestCase):
...
if __name__ == '__main__':
    SigningSubBill().test_signing_subbill()
