...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "clean_doinfo", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class CleanDoInfo(unittest.TestCase):
