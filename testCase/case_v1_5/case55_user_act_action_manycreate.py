# coding:utf-8
"""
v1.5-用户-优惠券相关-用户端-提交订单并使用优惠券（多账单生成订单）
"""
import unittest
...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "act_manycreate", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserActActionManyCreate(unittest.TestCase):
    ...
    def test_user_act_actmanycreate(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    UserActActionManyCreate().test_user_act_actmanycreate()
