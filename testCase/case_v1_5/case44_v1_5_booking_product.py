...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "booking_product", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class BookingProduct(unittest.TestCase):
...
if __name__ == '__main__':
    BookingProduct().test_booking_product()
