...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "act_action_use", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserActActionUse(unittest.TestCase):
    ...
    def test_user_act_actionuse(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    UserActActionUse().test_user_act_actionuse()
