...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "signing_info", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class SigningInfo(unittest.TestCase):
