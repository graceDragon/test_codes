...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "act_memcoupon_list", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserActMemcouponList(unittest.TestCase):
    ...
    def test_user_act_memcouponlist(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    UserActMemcouponList().test_user_act_memcouponlist()
