...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "intelligence_houseinfo", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class IntelligenceHouseInfo(unittest.TestCase):
    ...
    def test_intelligence_house_info(self):
        """
        test body
        :return:
        """
        # 给get或者post方法配置Http地址
        self.localConfigHttp = configHttp_new.ConfigHttp(env_old_new='v1.5', ENV_1_5='ccq')
...
if __name__ == '__main__':
    IntelligenceHouseInfo().test_intelligence_house_info()
