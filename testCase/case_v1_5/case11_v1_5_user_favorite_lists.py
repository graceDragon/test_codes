...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "user_favorite_lists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserFavoriteList(unittest.TestCase):
    ...
    def test_user_favorite_list(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    UserFavoriteList().test_user_favorite_list()
