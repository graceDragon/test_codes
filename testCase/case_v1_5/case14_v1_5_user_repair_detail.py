...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "user_repair_detail", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserRepairDetail(unittest.TestCase):
    ...
    def test_user_repair_detail(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    UserRepairDetail().test_user_repair_detail()
