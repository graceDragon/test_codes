# coding:utf-8
"""
v1.5-用户-优惠券相关-用户端-可用优惠券列表（UI分散社区 1-1-7-7001 房间id：1639866）
"""
import unittest
...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "act_action_list", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserActActionList(unittest.TestCase):
    ...
    def test_user_act_actionlist(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    UserActActionList().test_user_act_actionlist()
