...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "user_common_agreement", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserCommonAgreement(unittest.TestCase):
    ...
    def test_user_common_agreement(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    UserCommonAgreement().test_user_common_agreement()
