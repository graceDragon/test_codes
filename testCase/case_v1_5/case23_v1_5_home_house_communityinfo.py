...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "home_communityinfo", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class HomeCommunityInfo(unittest.TestCase):
    ...
    def test_home_communityinfo(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    HomeCommunityInfo().test_home_communityinfo()
