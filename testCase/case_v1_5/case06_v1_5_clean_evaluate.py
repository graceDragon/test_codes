...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "clean_evaluate", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class CleanEvaluate(unittest.TestCase):
...
if __name__ == '__main__':
    CleanEvaluate().test_clean_evaluate()
