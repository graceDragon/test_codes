...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "intelligence_houselists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class IntelligenceHouseLists(unittest.TestCase):
...
if __name__ == '__main__':
    IntelligenceHouseLists().test_intelligence_house_info()
