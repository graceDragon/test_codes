...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "clean_doevaluate", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class CleanDoEvaluate(unittest.TestCase):
    ...
    def test_clean_doevaluate(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    CleanDoEvaluate().test_clean_doevaluate()
