...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "user_verifypwd", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserVerifyPwd(unittest.TestCase):
...
if __name__ == '__main__':
    UserVerifyPwd().test_user_verifypwd()
