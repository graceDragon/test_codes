...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "home_searchinfo", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class HomeSearchInfo(unittest.TestCase):
...
if __name__ == '__main__':
    HomeSearchInfo().test_home_searchinfo()
