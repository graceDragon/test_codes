...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "user_bill_info", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserBillInfo(unittest.TestCase):
...
if __name__ == '__main__':
    UserBillInfo().test_user_bill_info()
