...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "wallet_bank_unbind", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class WalletUnbind(unittest.TestCase):
...
if __name__ == '__main__':
    WalletUnbind().test_wallet_unbind()
