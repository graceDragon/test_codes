...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "act_recommend_invitelist", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserActRecommendInviteList(unittest.TestCase):
    ...
    def test_user_act_recommend_invitelist(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    UserActRecommendInviteList().test_user_act_recommend_invitelist()
