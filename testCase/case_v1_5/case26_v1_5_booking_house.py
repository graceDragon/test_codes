...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "booking_house", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class BookingHouse(unittest.TestCase):
...
if __name__ == '__main__':
    BookingHouse().test_booking_house()
