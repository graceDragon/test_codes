...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "booking_cancel_01", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class BookingCancel(unittest.TestCase):
...
if __name__ == '__main__':
    BookingCancel().test_booking_cancel()
