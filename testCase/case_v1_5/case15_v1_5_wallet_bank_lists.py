...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "wallet_bank_lists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class WalletBankLists(unittest.TestCase):
    ...
    def test_wallet_bank_lists(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    WalletBankLists().test_wallet_bank_lists()
