...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "account_todo", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserAccountToDo(unittest.TestCase):
...
if __name__ == '__main__':
    UserAccountToDo().test_account_todo()
