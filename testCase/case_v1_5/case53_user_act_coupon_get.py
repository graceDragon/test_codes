...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "act_coupon_get", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserActCouponGet(unittest.TestCase):
    ...
    def test_user_act_couponget(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    UserActCouponGet().test_user_act_couponget()
