...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "user_order_lists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserOrderLists(unittest.TestCase):
    ...
    def test_user_order_lists(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    UserOrderLists().test_user_order_lists()
