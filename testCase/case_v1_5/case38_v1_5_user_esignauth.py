...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "user_esign_auth", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserEsignAuth(unittest.TestCase):
...
if __name__ == '__main__':
    UserEsignAuth().test_user_esignauth()
