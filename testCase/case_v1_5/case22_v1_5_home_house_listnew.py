...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "home_houselistnew", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class HomeHouseListNew(unittest.TestCase):
    ...
    def test_home_houselistnew(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    HomeHouseListNew().test_home_houselistnew()
