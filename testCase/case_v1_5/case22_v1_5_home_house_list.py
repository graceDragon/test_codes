...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "home_houselist", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class HomeHouseList(unittest.TestCase):
...
if __name__ == '__main__':
    HomeHouseList().test_home_houselist()
