...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "user_getsmscode", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class UserGetSmsCode(unittest.TestCase):
...
if __name__ == '__main__':
    UserGetSmsCode().test_user_getsmscode()
