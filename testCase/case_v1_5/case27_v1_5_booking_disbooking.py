...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "booking_disbooking", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class BookingDisBooking(unittest.TestCase):
    ...
    def test_booking_disbooking(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    BookingDisBooking().test_booking_disbooking()
