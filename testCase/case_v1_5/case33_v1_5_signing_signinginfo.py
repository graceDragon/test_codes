...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "signing_signinginfo", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class SigningSigningInfo(unittest.TestCase):
    ...
    def test_signing_signinginfo(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    SigningSigningInfo().test_signing_signingindfo()
