...
guanjia_accounts_xls = common.get_xls("v1.5.xlsx", "home_community_list", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class HomeCommunityList(unittest.TestCase):
    ...
    def test_home_community_list(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    HomeCommunityList().test_home_community_list()
