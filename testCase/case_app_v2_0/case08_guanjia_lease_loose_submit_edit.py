...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "lease_loose_submit_edit", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLeaseLooseEditSubmit(unittest.TestCase):
    ...
    def test_lease_loose_edit_submit(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLeaseLooseEditSubmit().test_lease_loose_edit_submit()
