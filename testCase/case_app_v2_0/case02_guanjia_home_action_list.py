...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "home_notice_list", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaHomeNoticeList(unittest.TestCase):
    ...
    def test_home_notice_list(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaHomeNoticeList().test_home_notice_list()
