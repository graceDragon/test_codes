...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "cw_orders_rollback", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaCwOrdersRollback(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sql2 = "UPDATE ft_orders SET STATUS = 1 WHERE id = '19671';"
    ...
    def tearDown(self):
        ...
        sql2 = "UPDATE ft_orders SET STATUS = 1 WHERE id = '19671';"
        configDB.MyDB().zhiyu_run_sql(sql2)
        sql1 = "INSERT INTO ft_orders_paylog(orders_id,account_id,amount, create_time) VALUES ('19671', '1', '16400', '1528394432');"
        configDB.MyDB().zhiyu_run_sql(sql1)


    def test_cw_orders_rollback(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaCwOrdersRollback().test_cw_orders_rollback()
