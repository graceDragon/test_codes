...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "lease_community_addonefloor", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLeaseCommunityAddOneFloor(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaLeaseCommunityAddOneFloor().test_lease_community_addonefloor()
