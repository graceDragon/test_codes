...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "lease_rentapply_doedit_01", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLeaseRentApplyDoEdit01(unittest.TestCase):
    ...
    def test_lease_rentapply_doedit01(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLeaseRentApplyDoEdit01().test_lease_rentapply_doedit01()
