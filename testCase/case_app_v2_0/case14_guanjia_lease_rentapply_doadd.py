...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "lease_rentapply_doadd", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLeaseRentApplyDoAdd(unittest.TestCase):
    ...
    def test_lease_rentapply_doadd(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLeaseRentApplyDoAdd().test_lease_rentapply_doadd()
