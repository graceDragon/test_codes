...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "cw_orders_lists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaCwOrdersLists(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaCwOrdersLists().test_cw_orders_lists()
