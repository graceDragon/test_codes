...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "cw_orders_detail", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaCwOrdersDetail(unittest.TestCase):
    ...
    def test_cw_orders_detail(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaCwOrdersDetail().test_cw_orders_detail()
