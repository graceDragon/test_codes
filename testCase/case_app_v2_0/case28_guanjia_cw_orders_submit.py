...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "cw_orders_submit", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaCwOrdersSubmit(unittest.TestCase):
    ...
    def test_cw_orders_submit(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaCwOrdersSubmit().test_cw_orders_submit()
