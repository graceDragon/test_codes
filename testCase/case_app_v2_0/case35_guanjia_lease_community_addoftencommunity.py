...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "lease_community_addoftencommu", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLeaseCommunityAddOftenCommunity(unittest.TestCase):
    ...
    def test_lease_community_addoftencommunity(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLeaseCommunityAddOftenCommunity().test_lease_community_addoftencommunity()
