...
"""
管家app2.0接口
管家-租入-租入申请-删除记录(执行删除的动作)超级删除-删除另一个订单
"""
import unittest
...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "lease_rentapply_del_02", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLeaseRentApplyDel02_1(unittest.TestCase):
    ...
    def test_lease_rentapply_del02(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLeaseRentApplyDel02_1().test_lease_rentapply_del02()
