...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "cw_orders_handle", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaCwOrdersHandle(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sql1 = "UPDATE ft_orders SET rollback_status = 1 WHERE id = '10980';"
    ...
    def test_cw_orders_handle(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaCwOrdersHandle().test_cw_orders_handle()
