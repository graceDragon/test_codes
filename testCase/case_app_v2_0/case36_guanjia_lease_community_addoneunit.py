...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "lease_community_addoneunit", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLeaseCommunityAddOneUnit(unittest.TestCase):
    ...
    def test_lease_community_addoneunit(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLeaseCommunityAddOneUnit().test_lease_community_addoneunit()
