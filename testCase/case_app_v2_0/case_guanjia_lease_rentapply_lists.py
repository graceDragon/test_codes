...
guanjia_accounts_xls = common.get_xls("app_v2.0.xlsx", "lease_rentapply_lists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLeaseRentApplyLists(unittest.TestCase):
    ...
    def test_lease_rentapply_lists(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLeaseRentApplyLists().test_lease_rentapply_lists()
