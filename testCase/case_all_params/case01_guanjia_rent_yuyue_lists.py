...
guanjia_accounts_xls = common.get_xls("all_params.xlsx", "guanjia_yuyue_list", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentYuyueList(unittest.TestCase):
    ...
    def test_guanjia_rent_yuyue_list(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentYuyueList().test_guanjia_rent_yuyue_list()
