...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_home_signing", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentHomeSigning(unittest.TestCase):
    ...
    def test_rent_home_signing(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentHomeSigning().test_rent_home_signing()
