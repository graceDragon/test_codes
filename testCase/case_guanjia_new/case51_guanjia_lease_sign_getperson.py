...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "lease_sign_getperson", tag=tag)
...
class GuanJiaLeaseSignGetperson(unittest.TestCase):
    ...
    def test_lease_sign_getperson(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLeaseSignGetperson().test_lease_sign_getperson()
