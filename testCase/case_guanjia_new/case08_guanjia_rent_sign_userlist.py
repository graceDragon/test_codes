...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_sign_userlist", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentSignUserList(unittest.TestCase):
    ...
    def test_rent_sign_userlist(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentSignUserList().test_rent_sign_userlist()
