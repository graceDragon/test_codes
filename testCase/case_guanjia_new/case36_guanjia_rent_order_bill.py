...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_order_bill", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentOrderBill(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaRentOrderBill().test_rent_order_bill()
