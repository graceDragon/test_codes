...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_reside_shortcut", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentResideShortCut(unittest.TestCase):
    ...
    def test_rent_reside_shortcut(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentResideShortCut().test_rent_reside_shortcut()
