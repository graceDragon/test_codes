...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_change_house", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentChangeHouse(unittest.TestCase):
    ...
    def test_rent_change_house(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentChangeHouse().test_rent_change_house()
