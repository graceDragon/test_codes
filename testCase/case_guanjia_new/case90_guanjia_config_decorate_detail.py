...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "conf_decorate_detail", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaConfDecorateDetail(unittest.TestCase):
    ...
    def test_rent_conf_decorate_detail(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaConfDecorateDetail().test_rent_conf_decorate_detail()
