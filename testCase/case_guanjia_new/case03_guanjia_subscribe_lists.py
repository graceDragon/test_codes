...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "subscribe_lists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentSubscribeLists(unittest.TestCase):
    ...
    def test_guanjia_rent_subscribe_lists(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentSubscribeLists().test_guanjia_rent_subscribe_lists()
