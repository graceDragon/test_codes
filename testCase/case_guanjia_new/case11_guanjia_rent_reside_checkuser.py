...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_reside_checkuser", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentCheckUser(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        # sql = localReadConfig.get_ini('SQL', 'sql_reset_house_status')
        # configDB.MyDB().zhiyu_run_sql(sql)


if __name__ == '__main__':
    GuanJiaRentCheckUser().test_rent_check_user()
