...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_order_add", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentOrderAdd(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaRentOrderAdd().test_rent_order_add()
