...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "lease_sign_doedit", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLeaseSignDoEdit(unittest.TestCase):
    ...
    def test_lease_sign_doedit(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLeaseSignDoEdit().test_lease_sign_doedit()
