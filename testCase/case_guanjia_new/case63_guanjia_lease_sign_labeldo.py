...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "lease_sign_labeldo", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLeaseSignLabelDo(unittest.TestCase):
    ...
    def test_lease_sign_labeldo(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLeaseSignLabelDo().test_lease_sign_labeldo()
