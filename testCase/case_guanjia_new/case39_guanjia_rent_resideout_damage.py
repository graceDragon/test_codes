...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_resideout_damage", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentResideoutDamage(unittest.TestCase):
    ...
    def test_rent_resideout_damage(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentResideoutDamage().test_rent_resideout_damage()
