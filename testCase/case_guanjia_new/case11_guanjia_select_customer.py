...
guanjia_accounts_xls = common.get_xls("guanjia_accounts.xlsx", "sign_select_customer", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaSelectCustomer(unittest.TestCase):
    ...
    def test_guanjia_sign_select_customer(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaSelectCustomer().test_guanjia_sign_select_customer()
