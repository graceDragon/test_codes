...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "conf_order_index", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaConfOrderIndex(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaConfOrderIndex().test_rent_conf_order_index()
