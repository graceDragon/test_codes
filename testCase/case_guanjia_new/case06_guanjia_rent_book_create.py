...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_book_create", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentBookCreate(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaRentBookCreate().test_rent_book_create()
