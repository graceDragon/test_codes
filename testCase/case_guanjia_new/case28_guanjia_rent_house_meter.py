...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_house_meter", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentHouseMeter(unittest.TestCase):
    ...
    def test_rent_house_meter(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentHouseMeter().test_rent_house_meter()
