...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "lease_sign_cost", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLeaseSignCost(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaLeaseSignCost().test_lease_sign_cost()
