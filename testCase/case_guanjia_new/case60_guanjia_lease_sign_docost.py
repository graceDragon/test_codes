...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "lease_sign_docost", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLeaseSignDoCost(unittest.TestCase):
    ...
    def test_lease_sign_docost(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLeaseSignDoCost().test_lease_sign_docost()
