...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "decorate_apply_submit", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaDecorateApplySubmit(unittest.TestCase):
    ...
    def test_rent_decorate_apply_submit(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaDecorateApplySubmit().test_rent_decorate_apply_submit()
