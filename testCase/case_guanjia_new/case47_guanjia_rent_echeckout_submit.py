...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_echeckout_submit", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentEcheckoutSubmit(unittest.TestCase):
    ...
    def test_rent_checkout_submit(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentEcheckoutSubmit().test_rent_checkout_submit()
