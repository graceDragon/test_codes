...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_bill_upremark", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentBillUpRemark(unittest.TestCase):
    ...
    def test_rent_bill_upremark(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentBillUpRemark().test_rent_bill_upremark()
