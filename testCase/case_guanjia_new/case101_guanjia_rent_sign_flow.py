...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_sign_flow", tag=tag)
...
class GuanJiaRentSignSubmit(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # sql1 = "UPDATE fy_house SET STATUS = '2' WHERE id = '1636808';"
        # configDB.MyDB().zhiyu_run_sql(sql1)
        # sql = "UPDATE ft_signing SET STATUS = '5' WHERE house_id = '1636808';"
