...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "conf_order_feelist", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaConfOrderFeeList(unittest.TestCase):
    ...
    def test_rent_conf_order_feelist(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaConfOrderFeeList().test_rent_conf_order_feelist()
