...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_reside_index", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentResideIndex(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaRentResideIndex().test_rent_reside_index()
