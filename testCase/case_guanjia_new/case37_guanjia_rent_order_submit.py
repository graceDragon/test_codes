...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_order_submit", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentOrderSubmit(unittest.TestCase):
    ...
    def test_rent_order_submit(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentOrderSubmit().test_rent_order_submit()
