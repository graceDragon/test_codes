...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "decorate_tmp_lists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaDecorateTmpLists(unittest.TestCase):
    ...
    def test_rent_decorate_tmplists(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaDecorateTmpLists().test_rent_decorate_tmplists()
