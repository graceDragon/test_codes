...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_house_getdatanum", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentHouseGetdatanum(unittest.TestCase):
    ...
    def test_guanjia_rent_getdatanum(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentHouseGetdatanum().test_guanjia_rent_getdatanum()
