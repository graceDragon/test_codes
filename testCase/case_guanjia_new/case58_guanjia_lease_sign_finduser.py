...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "lease_sign_finduser", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaLeaseSignFindUser(unittest.TestCase):
    ...
    def test_lease_sign_finduser(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaLeaseSignFindUser().test_lease_sign_finduser()
