...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_change_bill", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentChangeBill(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaRentChangeBill().test_rent_change_bill()
