...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "conf_order_qualitylist", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaConfOrderQualityList(unittest.TestCase):
    ...
    def test_rent_conf_order_quality_list(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaConfOrderQualityList().test_rent_conf_order_quality_list()
