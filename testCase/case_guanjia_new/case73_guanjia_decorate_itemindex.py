...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "decorate_item_index", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaDecorateIndex(unittest.TestCase):
    ...
    def test_rent_decorate_index(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaDecorateIndex().test_rent_decorate_index()
