...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_change_check", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentChangeCheck(unittest.TestCase):
    ...
    def test_rent_change_check(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentChangeCheck().test_rent_change_check()
