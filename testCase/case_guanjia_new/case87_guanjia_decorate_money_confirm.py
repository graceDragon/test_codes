...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "decorate_money_confirm", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaDecorateMoneyConfrim(unittest.TestCase):
    ...
    def test_rent_decorate_money_confirm(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaDecorateMoneyConfrim().test_rent_decorate_money_confirm()
