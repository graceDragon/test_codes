...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "decorate_tmp_submit", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaDecorateTmpSubmit(unittest.TestCase):
    ...
    def test_rent_decorate_tmpsubmit(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaDecorateTmpSubmit().test_rent_decorate_tmpsubmit()
