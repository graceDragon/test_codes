...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_relet_bill", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentReletBill(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaRentReletBill().test_rent_relet_bill()
