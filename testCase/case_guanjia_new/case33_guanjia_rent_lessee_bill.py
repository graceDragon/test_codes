...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_lessee_bill", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentLesseeBill(unittest.TestCase):
    ...
    def test_rent_lessee_bill(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentLesseeBill().test_rent_lessee_bill()
