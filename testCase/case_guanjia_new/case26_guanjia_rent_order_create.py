...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_order_create", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentOrderCreate(unittest.TestCase):
    ...
    def test_rent_order_create(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentOrderCreate().test_rent_order_create()
