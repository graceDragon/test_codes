...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_repair_lists", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentRepairLists(unittest.TestCase):
    ...
    def test_rent_repair_lists(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentRepairLists().test_rent_repair_lists()
