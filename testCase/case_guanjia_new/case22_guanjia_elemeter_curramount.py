...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_elemeter_currAmount", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentElemeterCurrAmount(unittest.TestCase):
    ...
    def test_rent_elemeter_curramount(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentElemeterCurrAmount().test_rent_elemeter_curramount()
