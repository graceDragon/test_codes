...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_fee_create", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentFeeCreate(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaRentFeeCreate().test_rent_fee_create()
