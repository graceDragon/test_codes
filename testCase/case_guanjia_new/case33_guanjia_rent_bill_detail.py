...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_bill_detail", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentBillDetail(unittest.TestCase):
    ...
    def test_rent_bill_detail(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaRentBillDetail().test_rent_bill_detail()
