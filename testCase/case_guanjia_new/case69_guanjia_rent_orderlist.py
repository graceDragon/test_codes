...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "rent_order_orderlist", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaRentOrderList(unittest.TestCase):
...
if __name__ == '__main__':
    GuanJiaRentOrderList().test_rent_orderlist()
