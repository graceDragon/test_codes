...
guanjia_accounts_xls = common.get_xls("guanjia_new.xlsx", "conf_decorate_loglist", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class GuanJiaConfDecorateLogList(unittest.TestCase):
    ...
    def test_rent_conf_decorate_log_list(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    GuanJiaConfDecorateLogList().test_rent_conf_decorate_log_list()
