...
guanjia_accounts_xls = common.get_xls("case_repair.xlsx", "repair_category_startusing", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class RepairCategoryListUsing(unittest.TestCase):
    ...
    def test_repair_category_listusing(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    RepairCategoryListUsing().test_repair_category_listusing()
