...
guanjia_accounts_xls = common.get_xls("case_repair.xlsx", "repair_category_detail", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class RepairCategoryDetail(unittest.TestCase):
    ...
    def test_repair_category_detail(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    RepairCategoryDetail().test_repair_category_detail()
