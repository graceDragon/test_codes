...
guanjia_accounts_xls = common.get_xls("case_repair.xlsx", "repair_apply_add", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class RepairApplyAdd(unittest.TestCase):
    ...
    def test_repair_apply_add(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    RepairApplyAdd().test_repair_apply_add()
