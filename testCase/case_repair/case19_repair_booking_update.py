...
guanjia_accounts_xls = common.get_xls("case_repair.xlsx", "repair_booking_update", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class RepairBookUpdate(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # sql = "DELETE FROM repair_booking WHERE app_id = 429;"
    ...
    def test_repair_book_update(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    RepairBookUpdate().test_repair_book_update()
