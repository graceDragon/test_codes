...
guanjia_accounts_xls = common.get_xls("case_repair.xlsx", "repair_cost_renterbill", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class RepairCostRentBill(unittest.TestCase):
    ...
    def test_repair_cost_renter_bill(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    RepairCostRentBill().test_repair_cost_renter_bill()
