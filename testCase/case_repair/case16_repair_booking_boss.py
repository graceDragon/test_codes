...
guanjia_accounts_xls = common.get_xls("case_repair.xlsx", "repair_booking_boss", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class RepairBookBoss(unittest.TestCase):
    ...
    def test_repair_book_boss(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    RepairBookBoss().test_repair_book_boss()
