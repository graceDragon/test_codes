...
guanjia_accounts_xls = common.get_xls("case_repair.xlsx", "repair_booking_add", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class RepairBookAdd(unittest.TestCase):
...
if __name__ == '__main__':
    RepairBookAdd().test_repair_book_add()
