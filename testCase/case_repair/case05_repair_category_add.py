...
guanjia_accounts_xls = common.get_xls("case_repair.xlsx", "repair_category_add", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class RepairCategoryAdd(unittest.TestCase):
...
if __name__ == '__main__':
    RepairCategoryAdd().test_repair_category_add()
