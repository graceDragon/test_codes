...
guanjia_accounts_xls = common.get_xls("case_repair.xlsx", "repair_goods_update", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class RepairGoodsUpdate(unittest.TestCase):
    ...
    def test_repair_goods_update(self):
        """
        test body
        :return:
        """
...
if __name__ == '__main__':
    RepairGoodsUpdate().test_repair_goods_update()
