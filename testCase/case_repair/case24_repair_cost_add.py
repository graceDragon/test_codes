...
guanjia_accounts_xls = common.get_xls("case_repair.xlsx", "repair_cost_add", tag=tag)
print 'excel里测试用例列表:\n', guanjia_accounts_xls


@paramunittest.parametrized(*guanjia_accounts_xls)
class RepairCostAdd(unittest.TestCase):
...
if __name__ == '__main__':
    RepairCostAdd().test_repair_cost_add()
